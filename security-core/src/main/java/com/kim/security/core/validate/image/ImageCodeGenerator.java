...
import com.kim.security.core.properties.ImageCodeProperties;
...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode generate(ServletWebRequest request) {
        ...
        Map<String, Object> imageCode1 = getImageCode(image.getWidth(), image.getHeight(), image.getLength());
        ImageCode imageCode = new ImageCode((BufferedImage) imageCode1.get("image"), imageCode1.get("strEnsure").toString(), 60);
        System.out.println("调用图形验证码生成器");
        return imageCode;
    }
    ...
    public static Map<String, Object> getImageCode(int width, int height, int length) {
